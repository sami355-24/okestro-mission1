...
INSERT INTO network (network_id, name, open_ip, open_port, create_at, update_at)
VALUES
    ...
    (5, "NETWORK5", "1.1.1.5", 10004, CURRENT_TIMESTAMP, NULL),
    (6, "NETWORK6", "1.1.1.6", 10005, CURRENT_TIMESTAMP, NULL),
    (7, "NETWORK7", "1.1.1.7", 10006, CURRENT_TIMESTAMP, NULL);
