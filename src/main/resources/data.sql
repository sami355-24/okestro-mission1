...
VALUES
    (1, NOW(), NULL, 'user1@example.com', 'password1');

INSERT INTO vm (vm_id, member_id, memory, storage, vcpu, create_at, update_at, description, private_ip, title, vm_status)
VALUES
    (1, 1, 16, 4, 4, NOW(), NULL, 'Test VM 1', '192.168.10.10', 'VM1', 'STARTING'),
    (2, 1, 8, 8, 2, NOW(), NULL, 'Test VM 2', '192.168.10.11', 'VM2', 'RUNNING'),
    (3, 1, 16, 16, 4, NOW(), NULL, 'Test VM 3', '192.168.10.12', 'VM3', 'PENDING'),
    (4, 1, 16, 32, 4, NOW(), NULL, 'Test VM 4', '192.168.10.13', 'VM4', 'REBOOTING'),
    (5, 1, 32, 64, 4, NOW(), NULL, 'Test VM 5', '192.168.10.14', 'VM5', 'TERMINATING'),
    (6, 1, 16, 128, 4, NOW(), NULL, 'Test VM 6', '192.168.10.15', 'VM6', 'TERMINATED');
...
VALUES
    (1, 1, NOW(), NULL, '10.0.0.1'),
    (2, 2, NOW(), NULL, '10.0.0.2');

INSERT INTO outbound_ip (outbound_ip_id, vm_id, create_at, update_at, address)
VALUES
    (1, 1, NOW(), NULL, '8.8.8.8'),
    (2, 2, NOW(), NULL, '8.8.4.4');
