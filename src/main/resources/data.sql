...
VALUES
    ...
    (7, "NETWORK7", "1.1.1.7", 10006, CURRENT_TIMESTAMP, NULL, 7),
    (8, "NETWORK8", "1.1.1.8", 10007, CURRENT_TIMESTAMP, NULL, 8),
    (9, "NETWORK9", "1.1.1.9", 10008, CURRENT_TIMESTAMP, NULL, 9),
    (10, "NETWORK10", "1.1.1.10", 10009, CURRENT_TIMESTAMP, NULL, NULL),
    (11, "NETWOR11", "1.1.1.11", 10010, CURRENT_TIMESTAMP, NULL, NULL),
    (12, "NETWORK12", "1.1.1.12", 10011, CURRENT_TIMESTAMP, NULL, NULL),
    (13, "NETWORK13", "1.1.1.13", 10012, CURRENT_TIMESTAMP, NULL, NULL),
    (14, "NETWORK14", "1.1.1.14", 10013, CURRENT_TIMESTAMP, NULL, NULL),
    (15, "NETWORK15", "1.1.1.15", 10014, CURRENT_TIMESTAMP, NULL, NULL);
